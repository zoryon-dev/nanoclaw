...
export class WhatsAppChannel implements Channel {
  ...
  // Resolve callback for the initial connect() Promise.
  // Stored as instance field so reconnections can still resolve it.
  ...
  private async connectInternal(): Promise<void> {
    ...
    this.sock.ev.on('connection.update', (update) => {
      ...
      if (connection === 'close') {
        ...
        // Signal first connection to caller (works even after reconnect)
